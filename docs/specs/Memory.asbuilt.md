...
| KB1 | NotebookLM | Google NotebookLM API | Curated reference documents: research papers, technical docs, guides | `agentbridge-kb query --query "..." --chat-id <id>` | External — grounded answers with citations, cached responses |
