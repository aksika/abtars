# Report Pipeline E2E — e2e-1786095645159-c681649d
...
| M30 | Non-settling provider: forced terminal + slot release + cleanup timeout | PASS | timeout |
...
**45/48 PASS** (3 FAIL, 0 BLOCKED, 0 NOT_RUN)