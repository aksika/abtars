# Report Pipeline E2E — e2e-1786094958396-5f049c99
...
| M13 | Execution control can be registered and removed | FAIL | runner |
...
| M17 | Spin dispatchAwait accepts caller-owned settlement | FAIL | execution |
...
| M34 | reconcileActiveTaskRuns clears stale active runs | FAIL | state |
...
| M46 | daily-ai shaped task normalizes and preflights | FAIL | production |
| M47 | weekly-ai shaped task normalizes and preflights | FAIL | production |
| M48 | finance-daily shaped task normalizes and preflights | FAIL | production |

**41/48 PASS** (7 FAIL, 0 BLOCKED, 0 NOT_RUN)