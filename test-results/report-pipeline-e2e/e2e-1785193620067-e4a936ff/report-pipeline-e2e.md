# Report Pipeline E2E — e2e-1785193620067-e4a936ff
...
| M08b | Required file present → preflight passes | PASS | preflight |
...
| M16 | Provider/model selection is interface-driven | FAIL | execution |
...
| M38b | Rejects artifact with mtime before reservation | PASS | artifact |
...
**56/57 PASS** (1 FAIL, 0 BLOCKED, 0 NOT_RUN)